...
We are working off a 365 day year and assume 8 age classes (0 - 7). 
...
Project<-KrillProjection(nsteps, Ages,					 #time step numbers and age classes
								 ...
								 B0logsd,
								 gamma=seq(0,0.1,by=0.01),       #gammas to test
...
```{r}
Runs<-1000 #Set number of iterations
